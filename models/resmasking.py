...
class ResNet(nn.Module):
    def __init__(
        ...
        self.conv1 = nn.Conv2d(in_channels, self.inplanes, kernel_size=5, padding=2, bias=False)
...
class ResMasking(ResNet):
    def __init__(self, weight_path):
        super(ResMasking, self).__init__(
            block=BasicBlock, layers=[3, 4, 6, 3], in_channels=1, num_classes=1000
        )
